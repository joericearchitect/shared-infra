...
resource "aws_instance" "infra-build-az-1" {
	...
	tags {
        Name = "${var.environment}.instance.swarm-worker.infra-infra-build.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}",
        jra.instance-name-full = "${var.environment}.instance.swarm-worker.infra-infra-build.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}"
        jra.instance-name = "infra-infra-build-${var.region}-az-1"
...
resource "aws_instance" "infra-persistence-az-1" {
	...
	tags {
        Name = "${var.environment}.instance.swarm-worker.infra-infra-persistence.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}",
        jra.instance-name-full = "${var.environment}.instance.swarm-worker.infra-infra-persistence.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}"
        jra.instance-name = "infra-infra-persistence-${var.region}-az-1"
        jra.environment = "${var.environment}"
        jra.environment_type = "${var.environment_type}"
        jra.environment-instance-id = "${random_id.env-instance.b64}"
    	jra.failure-zone = "${var.region}-az-1"
    	jra.environment-size = "${var.environment-size}"
    	jra.swarm-instance-type = "swarm-worker"
    	jra.swarm-node-type = "infra-infra-persistence"
    	jra.subnet-type = "private"
    }
}
...
resource "aws_instance" "infra-repos-az-1" {
	...
	tags {
        Name = "${var.environment}.instance.swarm-worker.infra-infra-repos.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}",
        jra.instance-name-full = "${var.environment}.instance.swarm-worker.infra-infra-repos.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}"
        jra.instance-name = "infra-infra-repos-${var.region}-az-1"
        jra.environment = "${var.environment}"
        jra.environment_type = "${var.environment_type}"
        jra.environment-instance-id = "${random_id.env-instance.b64}"
    	jra.failure-zone = "${var.region}-az-1"
    	jra.environment-size = "${var.environment-size}"
    	jra.swarm-instance-type = "swarm-worker"
    	jra.swarm-node-type = "infra-infra-repos"
    	jra.subnet-type = "private"
    }
}
