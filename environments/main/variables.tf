...
variable "ec2-instance-type" {
  ...
  default = {
    ...
    medium.infra-build = "t2.medium"
    medium.infra-load = "t2.medium"
    medium.infra-repos = "t2.medium"

    large.swarm-manager = "m4.large"
    large.swarm-manager = "t2.medium"
    large.build = "t2.medium"
    large.app-ui-web = "t2.medium"
    large.admin-ui-web = "m4.large"
    large.app-api-web = "t2.medium"
    large.app-api-service = "t2.medium"
    large.app-api-service-large = "t2.medium"
    large.app-persistence = "t2.medium"
    large.app-persistence-large = "t2.medium"
    large.infra-logging = "m4.large"
    large.management = "t2.medium"
    large.management-persistence = "t2.medium"
    large.admin = "t2.medium"
    large.infra-monitoring = "m4.large"
    large.infra-persistence = "t2.medium"
    large.infra-build = "t2.medium"
    large.infra-load = "t2.medium"
    large.infra-repos = "m4.large"
  }
}
