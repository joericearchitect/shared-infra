...
resource "aws_instance" "app-ui-web-az-1" {
	...
	tags {
        ...
        jra.instance-name-full = "${var.environment}.instance.swarm-worker.app-ui-web.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-1")}"
        jra.instance-name = "app-ui-web-${var.region}-az-1"
...
resource "aws_instance" "app-ui-web-az-2" {
	...
	tags {
        ...
        jra.instance-name-full = "${var.environment}.instance.swarm-worker.app-ui-web.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-2")}"
        jra.instance-name = "app-ui-web-${var.region}-az-2"
        jra.environment = "${var.environment}"
        jra.environment_type = "${var.environment_type}"
        jra.environment-instance-id = "${random_id.env-instance.b64}"
...
resource "aws_instance" "app-ui-web-az-3" {
	...
	tags {
        ...
        jra.instance-name-full = "${var.environment}.instance.swarm-worker.app-ui-web.${var.environment}.${lookup(var.availability_zone, "${var.region}.az-3")}"
        jra.instance-name = "app-ui-web-${var.region}-az-3"
        jra.environment = "${var.environment}"
        jra.environment_type = "${var.environment_type}"
        jra.environment-instance-id = "${random_id.env-instance.b64}"
