...
export PATH=$PATH:$SCRIPTS_DIR_INFRA_GLOBAL:$SCRIPTS_DIR_INFRA_DOCKER:$SCRIPTS_DIR_INFRA_DEV_ENV:$SCRIPTS_DIR_INFRA_DEV_ENV_LOCAL:$SCRIPTS_DIR_INFRA_DEV_ENV_VM