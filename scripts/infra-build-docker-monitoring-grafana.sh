...
echo .
echo -------------------------------------------------------------
echo   Building Jarch Grafana Docker Image...
echo ------------------------------------------------

REPO_NAME=$JRA_GLOBAL_DOCKER_REPO_NAME
IMAGE_NAME=$JRA_GLOBAL_IMAGE_NAME_PREFIX_INFRA-grafana
IMAGE_VERSION=1.0.0
IMAGE_TAG_VERSION=$IMAGE_VERSION
IMAGE_TAG_LAGEST=latest

cd $INFRA_MODULES_MONITORING_DOCKER_DIR/grafana
...
echo .
echo -------------------------------------------------------------
echo   Pushing Jarch Grafana Docker Image to Registry...
echo ------------------------------------------------
