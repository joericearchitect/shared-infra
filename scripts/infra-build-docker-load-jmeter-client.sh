...
echo .
echo -------------------------------------------------------------
echo   Building Jarch JMeter Client Docker Image...
echo ------------------------------------------------

REPO_NAME=$JRA_GLOBAL_DOCKER_REPO_NAME
IMAGE_NAME=$JRA_GLOBAL_IMAGE_NAME_PREFIX_INFRA-jmeter-client
IMAGE_VERSION=1.0.0
...
echo .
echo -------------------------------------------------------------
echo   Pushing Jarch JMeter Client Docker Image to Registry...
echo ------------------------------------------------
